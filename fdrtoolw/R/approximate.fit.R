...
# first guess of null model parameters
approximate.fit = function(x, weight, statistic=c("pvalue"), lambda=seq(0,0.9,0.05))
{
  ...
  # estimate eta0
  eta0 = pval.estimate.eta0.w(pval, weight, method="quantile", q=0.1, diagnostic.plot=FALSE, lambda=lambda) 
